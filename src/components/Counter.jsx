...
import {decrement, increment,reset,incrementByAmount} from '../redex/counterSlice' 
  ...
  return (
    <div className='border rounded p-5 text-center'>
        ...
        <div className='d-flex justify-content-between align-items-center'>
           <input onChange={e=>setAmount(e.target.value)} placeholder='input amount to be increment' type="text" className='form-control' />
